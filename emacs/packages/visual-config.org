...
(use-package welcome-dashboard
  :straight (welcome-dashboard :type git
                      ...
                      :build t)
  :config
  (setq welcome-latitude 52.520008
        welcome-longitude 13.404954
        welcome-path-max-length 75
        welcome-min-left-padding 10
        ;; TODO: Fix the welcome image
        welcome-image-file (concat user-emacs-directory "straight/repos/evil/doc/logo.png")
        welcome-image-width 200
        welcome-image-height 169
        welcome-title "Welcome Victor. Have a great day!")
...
** COMMENT Solaire: Incandescent Emacs
