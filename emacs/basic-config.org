...
** Some other global configs
#+begin_src emacs-lisp
;; https://github.com/seagle0128/.emacs.d/blob/master/lisp/init-base.el
(use-package simple
  :ensure nil
...
*** Fonts
#+begin_src emacs-lisp
(set-face-attribute 'default nil :font "JetBrains Mono-12:spacing=100")
;; (set-face-attribute 'variable-pitch nil :family "JetBrains Mono-12" :height 1.0)
