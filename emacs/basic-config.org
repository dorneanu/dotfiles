...
#+begin_src emacs-lisp
(set-face-attribute 'default nil :font "Iosevka-14:slant=normal:weight=regular:width=normal")
(set-face-attribute 'variable-pitch nil :family "Source Code Pro" :height 1.0)
...
#+begin_src emacs-lisp
(defvar font-list '(("Source Code Pro" . 14) ("DejaVu Sans" . 14) ("DejaVu Sans Mono" . 14) ("Iosevka" . 14))
