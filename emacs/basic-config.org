...
#+begin_src emacs-lisp
;; (defvar phundrak/default-font-size 14
;;   "Default font size.")

;; (defvar phundrak/default-font-name "DejaVu Sans Mono"
;;   "Default font.")
...
(set-face-attribute 'variable-pitch nil :font "DejaVu Sans Mono" :height 120)
