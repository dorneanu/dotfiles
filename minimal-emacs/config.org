...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (26446 65533 683315 0) :init (26446 65533 683274 0) :init-secs (0 0 6310 0) :use-package-secs (0 0 49535 0) :config (26446 65533 683245 0) :config-secs (0 0 6273 0)))
