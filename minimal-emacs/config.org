...
(use-package embrace
  ...
  (add-hook 'org-mode-hook
            (lambda ()
              (embrace-add-pair-local ?b "*" "*")   ; bold
              (embrace-add-pair-local ?i "/" "/")   ; italic
              (embrace-add-pair-local ?c "~" "~")   ; code
              (embrace-add-pair-local ?v "=" "=")   ; verbatim
              (embrace-add-pair-local ?u "_" "_")   ; underline
              (embrace-add-pair-local ?s "+" "+"))) ; strikethrough

  (add-hook 'markdown-mode-hook
            (lambda ()
              (embrace-add-pair-local ?c "`" "`")))
...
(meow-define-keys 'org-motion
  ...
  '("k" .  (lambda () (interactive) (org-previous-visible-heading 1) (pulsar-recenter-top)))
  '("j" .  (lambda () (interactive) (org-next-visible-heading 1) (pulsar-recenter-top)))
  ;; Moving between headings at the same level
  '("p" .  (lambda () (interactive) (org-backward-heading-same-level 1) (pulsar-recenter-top)))
  '("n" .  (lambda () (interactive) (org-forward-heading-same-level 1) (pulsar-recenter-top)))
