...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (26417 62316 517790 0) :init (26417 62316 517786 0) :config (26417 62316 517666 0) :config-secs (0 0 4 0) :init-secs (0 0 694 0) :use-package-secs (0 0 5334 0)))
