...
*** Enhanced Org Emphasis Styling
 #+begin_src emacs-lisp
 ;; Enhanced emphasis styling - make bold/italic more visible
 (custom-set-faces
  ;; Bold text - using the correct 'bold' face (not 'org-bold')
  '(bold ((t (:weight ultra-bold :foreground "#e74c3c" :height 1.05))))
  ;; Italic text - using the correct 'italic' face
  '(italic ((t (:slant italic :foreground "#3498db" :weight normal))))
  ;; Underline text - using the correct 'underline' face
  '(underline ((t (:underline t :foreground "#9b59b6"))))
  ;; Code/verbatim text - these might be org-specific
