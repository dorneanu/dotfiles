...
(with-eval-after-load 'magit
  (define-key magit-diff-mode-map (kbd "C-c A c") #'claude-code-commit-message)
  (define-key magit-status-mode-map (kbd "C-c A c") #'claude-code-commit-message))
#+end_src
*** COMMENT magit-todos
#+begin_src emacs-lisp
...
(use-package pr-review
  ...
  :after (magit ghub)
  :custom
  ;; Configure for enterprise GitHub
  (pr-review-ghub-host "github.wdf.sap.corp/api/v3")
  :bind (:map forge-pullreq-mode-map
              ("C-c r" . my/pr-review-current-forge-pr))
  :config
