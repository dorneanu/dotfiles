...
#+begin_src emacs-lisp
  (use-package elfeed
    ...
    (+nmap! :keymaps 'elfeed-search-mode-map
            "fj" #'dorneanu/elfeed-cycle-filters-forward
            "fJ" #'dorneanu/elfeed-cycle-filters-backward
            "fk" #'dorneanu/elfeed-increase-time-filter
            "fK" #'dorneanu/elfeed-decrease-time-filter
            "fuu" #'elfeed-update
