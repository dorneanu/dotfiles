...
;; or built-in themes
(setq minemacs-theme 'solarized-dark-high-contrast) ; `doom-one' is a dark theme, `doom-one-light' is the light one
...
#+end_src
*** marginalia
Don't load marginalia by default:
...
(use-package elfeed
  ...
  (+nmap! :keymaps 'elfeed-search-mode-map
    ...
    "mgh" #'my/elfeed-hn-show-comments-at-point
